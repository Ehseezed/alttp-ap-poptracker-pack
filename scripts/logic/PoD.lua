...
dungeons_all:connect_two_ways(pod_three_way_room_left)
dungeons_all:connect_two_ways(pod_three_way_room_middle)
dungeons_all:connect_two_ways(pod_three_way_room_right)
